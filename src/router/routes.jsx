...
import ProductView from "../pages/Feature/products/productList/ViewProduct";
...
import Addbrand from "../pages/Feature/products/addBrand/index";
...
import EditBrand from "../pages/Feature/products/editBrand/index";
import ListCategory from "../pages/Feature/products/listCategory/index";
import ListBrand from "../pages/Feature/products/listBrand/index";
...
import ProductInventory from "../pages/Feature/productsInventory/productList/index";
import AddInventory from "../pages/Feature/productsInventory/addProduct/index";

import EditGoodsInward from "../pages/Feature/goodsInward/editPurchaseOrder/index";
import ViewGoodsInward from "../pages/Feature/goodsInward/viewPurchaseOrder/index";
import GoodsInward from "../pages/Feature/goodsInward/purchaseorderList/index";
import Pricing from "../pages/Feature/pricing/addPricing/index";
...
export const authRoutes = [
  ...
  },
  {
    ...
    {
    path: "/goods-invert-note",
    element:<ProductInventory />,
  },
  {
    path: `/add-goods-invert`,
  ...
  {
    path: `${"/view-goods-inward"}/:id`,
    element: <ViewGoodsInward />,
  },
  {
    path: `${"/edit-goods-inward"}/:id`,
    element: <EditGoodsInward />,
  },
  {
    path: `${"/pricing"}`,
    element: <Pricing />,
