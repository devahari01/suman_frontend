          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              ...
              >
                ...
                <li
                  ...
                  <ul
                    ...
                    <li
                      style={{
                        display: showHide("brand") ? "none" : "block",
                      }}
                      >
                      <Link
                        to="/brand"
                        className={`${
                          "/brand" === pathName ? "active" : ""
                        }`}
                      >
                        Brands
                      </Link>
                ...
                >
                  <Link to="/brand" onClick={() => toggleSidebar("")}>
                    <FeatherIcon icon="user" /> <span>Brands</span>
                  </Link>
                </li>
                <li
                  className={`${
                ...
                >
                  <Link to="/pricing" onClick={() => toggleSidebar("")}>
                    <FeatherIcon icon="user" /> <span>Pricing</span>
                  </Link>
                </li>
              </ul>
              ...
              >
                ...
                <li
                  className={`${
                    "/goods-inward" === pathName ||  "/edit-goods-inward" === pathName
                      ? "active"
                      : ""
                  }`}
                  style={{
                ...
                >
                  <Link to="/goods-inward" onClick={() => toggleSidebar("")}>
                    <FeatherIcon icon="package" /> <span>Goods Inward</span>
                  </Link>
                </li>
                <li
                  className={`${
