...
.shape({
  ...
  alertQuantity: yup
    ...
    mfgdate: yup
      ...
      .typeError("Enter a valid Manufacture Date"),
    expdate: yup
      .date()
      .required("Expire Date is required")
      .typeError("Enter a valid Expire Date")
      .min(yup.ref("mfgdate"), "Expire Date must be after Manufacture Date"),
    box: yup
      .number()
      .required("Box count is required")
      .typeError("Enter a valid number for Box count")
      .positive("Box count must be a positive number")
      .integer("Box count must be an integer"),
})
