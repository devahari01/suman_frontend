...
const ListPurchaseOrder = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render:(text,record) => (
        <Link
        to={(admin || permission?.view) ? { pathname: `${"/view-goods-inward"}/${record._id}` } : '#'}>
         <span>{text}</span>
      </Link>
      ),
    },
    ...
    },
    {
      ...
      render: (isChecked, record) => (
        <button
          className={`btn ${isChecked ? "btn-success" : "btn-danger"}`}
        ...
        <div className="d-flex align-items-center customer-details">
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-right credit-note-dropdown purchase-order-dropdown-menu">
              <ul>
                {(admin || permission?.update) && (!record.isChecked) && (
                  <li>
                    <Link
                      className="dropdown-item"
                      to={{
                        pathname: `${"/edit-goods-inward"}/${record._id}`,
                      }}
                    >
