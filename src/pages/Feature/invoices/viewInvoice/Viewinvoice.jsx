...
const ViewInvoice = () => {
  ...
  const totalTaxableAmount = invoiceData?.creditNotes?.reduce((sum, note) => {
    return sum + parseFloat(note.taxableAmount || 0);
  }, 0);
  useEffect(() => {
                                ...
                                <div className="invoice-total-box">
                                  <div className="invoice-total-inner">
                                    ...
                                    <p>
                                      ...
                                      <span>
                                        {currencyData ? currencyData : "$"}
                                        {amountFormat(invoiceData?.totalDiscount)}
                                      </span>
                                    </p>
                                  </div>
                                  {invoiceData?.creditNotes?.length > 0 && (
                                    <table className="table mt-3">
                                      ...
                                      <tbody>
                                        {invoiceData.creditNotes.map((note) => (
                                          <tr key={note._id}>
                                  ...
                                  <div className="invoice-total-footer">
                                    <h4>
                                      ...
                                      <span>
                                        {currencyData ? currencyData : "$"}
                                        {amountFormat(invoiceData?.TotalAmount - totalTaxableAmount - invoiceData?.totalDiscount)}
                                      </span>
                                    </h4>
                                  </div>
                                </div>
