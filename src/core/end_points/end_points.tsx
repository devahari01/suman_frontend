...
export const inventory_note = {
  ...
  Upadte: "/inventory_note",
  List: "/goods/listProduct",
  View: "/inventory_note",
  Delete: "/inventory_note",
};
...
export const downloadImageURL = "https://software.iyappaa.com:7005";
...
export const dropdown_api = {
  ...
  brand_api: "/drop_down/brand",
  product_api: "/drop_down/product",
  productSR_api: "/drop_down/productSR",
